...
contract IcoContract is SafeMath, Pausable {
  ...
  function createTokens(address _beneficiary, uint256 _value) internal whenNotPaused {
    ...
    if (_beneficiary == ethFundDeposit) {
      ...
      } else if ( now <= 1538755200 ){ //  10/05/2018 @ 4:00pm (UTC)
        if ( _value < 5000000000000000000) {
            // value < 5 ETH, 100%, 1 ETH = 5000 GBO
          tokens = safeMult(_value, 5000);
        } else if ( _value < 10000000000000000000){
          // value < 10 ETH, 105%, 1 ETH = 5250 GBO
          tokens = safeMult(_value, 5250);
        } else if ( _value < 30000000000000000000){
          // value < 30 ETH, 110%, 1 ETH = 5500 GBO
          tokens = safeMult(_value, 5500);
        } else {
          // value >=30 ETH, 115%, 1 ETH = 5750 GBO
          tokens = safeMult(_value, 5750);
        }
      } else if ( now <= 1539360000 ){ //  10/12/2018 @ 4:00pm (UTC)
        if ( _value < 5000000000000000000) {
            // value < 5 ETH, 100%, 1 ETH = 5000 GBO
          tokens = safeMult(_value, 5000);
        } else if ( _value < 10000000000000000000){
          // value < 10 ETH, 104%, 1 ETH = 5200 GBO
          tokens = safeMult(_value, 5200);
        } else if ( _value < 30000000000000000000){
          // value < 30 ETH, 109%, 1 ETH = 5450 GBO
          tokens = safeMult(_value, 5450);
        } else {
          // value >=30 ETH, 114%, 1 ETH = 5700 GBO
          tokens = safeMult(_value, 5700);
        }
      } else if ( now <= 1539964800 ){ //  10/19/2018 @ 4:00pm (UTC)
        if ( _value < 5000000000000000000) {
            // value < 5 ETH, 100%, 1 ETH = 5000 GBO
          tokens = safeMult(_value, 5000);
        } else if ( _value < 10000000000000000000){
          // value < 10 ETH, 103%, 1 ETH = 5150 GBO
          tokens = safeMult(_value, 5150);
        } else if ( _value < 30000000000000000000){
          // value < 30 ETH, 108%, 1 ETH = 5400 GBO
          tokens = safeMult(_value, 5400);
        } else {
          // value >=30 ETH, 113%, 1 ETH = 5650 GBO
          tokens = safeMult(_value, 5650);
        }
      } else if ( now <= 1540569600 ){ //  10/26/2018 @ 4:00pm (UTC)
        if ( _value < 5000000000000000000) {
            // value < 5 ETH, 100%, 1 ETH = 5000 GBO
          tokens = safeMult(_value, 5000);
        } else if ( _value < 10000000000000000000){
          // value < 10 ETH, 102%, 1 ETH = 5100 GBO
          tokens = safeMult(_value, 5100);
        } else if ( _value < 30000000000000000000){
          // value < 30 ETH, 107%, 1 ETH = 5350 GBO
          tokens = safeMult(_value, 5350);
        } else {
          // value >=30 ETH, 112%, 1 ETH = 5600 GBO
          tokens = safeMult(_value, 5600);
        }
      } else if ( now <= 1541174400 ){ //  11/02/2018 @ 4:00pm (UTC)
        if ( _value < 5000000000000000000) {
            // value < 5 ETH, 100%, 1 ETH = 5000 GBO
          tokens = safeMult(_value, 5000);
        } else if ( _value < 10000000000000000000){
          // value < 10 ETH, 101%, 1 ETH = 5050 GBO
          tokens = safeMult(_value, 5050);
        } else if ( _value < 30000000000000000000){
          // value < 30 ETH, 106%, 1 ETH = 5300 GBO
          tokens = safeMult(_value, 5300);
        } else {
          // value >=30 ETH, 111%, 1 ETH = 5550 GBO
          tokens = safeMult(_value, 5550);
        }
      } else if ( now <= 1541779200 ){ //  11/09/2018 @ 4:00pm (UTC)
        if ( _value < 10000000000000000000){
          // value < 10 ETH, 100%, 1 ETH = 5000 GBO
          tokens = safeMult(_value, 5000);
        } else if ( _value < 30000000000000000000){
          // value < 30 ETH, 105%, 1 ETH = 5250 GBO
          tokens = safeMult(_value, 5250);
        } else {
          // value >=30 ETH, 110%, 1 ETH = 5500 GBO
          tokens = safeMult(_value, 5500);
        }
      } else if ( now <= 1542384000 ){ //  11/16/2018 @ 4:00pm (UTC)
        if ( _value < 10000000000000000000){
          // value < 10 ETH, 100%, 1 ETH = 5000 GBO
          tokens = safeMult(_value, 5000);
        } else if ( _value < 30000000000000000000){
          // value < 30 ETH, 104%, 1 ETH = 5200 GBO
          tokens = safeMult(_value, 5200);
        } else {
          // value >=30 ETH, 109%, 1 ETH = 5450 GBO
          tokens = safeMult(_value, 5450);
        }
      } else if ( now <= 1542988800 ){ //  11/23/2018 @ 4:00pm (UTC)
        if ( _value < 10000000000000000000){
          // value < 10 ETH, 100%, 1 ETH = 5000 GBO
          tokens = safeMult(_value, 5000);
        } else if ( _value < 30000000000000000000){
          // value < 30 ETH, 103%, 1 ETH = 5150 GBO
          tokens = safeMult(_value, 5150);
        } else {
          // value >=30 ETH, 108%, 1 ETH = 5400 GBO
          tokens = safeMult(_value, 5400);
        }
      } else if ( now <= 1543593600 ){ //  11/30/2018 @ 4:00pm (UTC)
        if ( _value < 10000000000000000000){
          // value < 10 ETH, 100%, 1 ETH = 5000 GBO
          tokens = safeMult(_value, 5000);
        } else if ( _value < 30000000000000000000){
          // value < 30 ETH, 102%, 1 ETH = 5100 GBO
          tokens = safeMult(_value, 5100);
        } else {
          // value >=30 ETH, 107%, 1 ETH = 5350 GBO
          tokens = safeMult(_value, 5350);
        }
      } else if ( now <= 1544198400 ){ //  12/07/2018 @ 4:00pm (UTC)
        if ( _value < 10000000000000000000){
          // value < 10 ETH, 100%, 1 ETH = 5000 GBO
          tokens = safeMult(_value, 5000);
        } else if ( _value < 30000000000000000000){
          // value < 30 ETH, 101%, 1 ETH = 5050 GBO
          tokens = safeMult(_value, 5050);
        } else {
          // value >=30 ETH, 106%, 1 ETH = 5300 GBO
          tokens = safeMult(_value, 5300);
        }
      } else if ( now <= 1544803200 ){ //  12/14/2018 @ 4:00pm (UTC)
        if ( _value < 30000000000000000000){
          // value < 30 ETH, 100%, 1 ETH = 5000 GBO
          tokens = safeMult(_value, 5000);
        } else {
          // value >=30 ETH, 105%, 1 ETH = 5250 GBO
          tokens = safeMult(_value, 5250);
        }
      } else if ( now <= 1545408000 ){ //  12/21/2018 @ 4:00pm (UTC)
        if ( _value < 30000000000000000000){
          // value < 30 ETH, 100%, 1 ETH = 5000 GBO
          tokens = safeMult(_value, 5000);
        } else {
      ...
      } else if ( now <= 1546012800 ){ //  12/28/2018 @ 4:00pm (UTC)
        if ( _value < 30000000000000000000){
          // value < 30 ETH, 100%, 1 ETH = 5000 GBO
          tokens = safeMult(_value, 5000);
        } else {
